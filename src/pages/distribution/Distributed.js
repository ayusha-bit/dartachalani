...
const Distributed = () => {
  const [distributedData] = useState([
    {
      id: 101,
      letterNumber: 'LTR101',
      ...
      nepaliReceivedDate: '2082-02-25',
      distributionStatus: 'Distributed',
      urgency: 'High',
      remarks: 'Distribute to all departments',
      details: 'Details about Invitation Letter LTR101...'
    },
    {
      id: 102,
      letterNumber: 'LTR102',
      ...
      nepaliReceivedDate: '2082-02-26',
      distributionStatus: 'Distributed',
      urgency: 'Low',
      remarks: 'Distribute to HR only',
      details: 'Details about Policy Update LTR102...'
    },
  ]);
  ...
  return (
    ...
    <div style={{ padding: '30px', backgroundColor: '#f9f9f9', minHeight: '100vh' }}>
      <h1 style={{ marginBottom: '10px' }}>Distributed Letters</h1>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        ...
        <tbody>
          {distributedData
            .filter(item => item.distributionStatus === 'Distributed')
            .map((item) => (
              <tr key={item.id}>
